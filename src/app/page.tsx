      ...
      <section className="intro-track full-bleed py-16 sm:py-32 lg:py-40">
        ...
        <div className="intro-stage mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
            ...
            <figure className="parallax-plate relative mx-auto w-full max-w-[280px] sm:max-w-md lg:max-w-none">
              <div
                aria-hidden="true"
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-[0_24px_48px_-20px_rgba(47,42,37,0.3),inset_0_1px_0_rgba(255,255,255,0.5)] ring-1 ring-inset ring-brass/60 dark:shadow-none">
                ...
                <div
                  aria-hidden="true"
                  className="parallax-photo pointer-events-none absolute -inset-[15%] rounded-3xl bg-pine/[0.14] mix-blend-multiply dark:bg-choc/25"
                />
                <div
                  aria-hidden="true"
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Reveal index={0} className="sm:col-span-2 lg:col-span-2">
              ...
              >
                ...
                <div>
                  ...
                  <span aria-hidden="true" className="mt-4 mb-4 block h-[3px] w-14 rounded-full bg-brass/70 dark:bg-brass-dark/60" />
            ...
            <Reveal index={1}>
              <Link
                href="/class-12"
                className="group flex flex-col justify-between h-full rounded-2xl border border-brass/30 bg-surface-subtle p-6 sm:p-8 shadow-[0_1px_2px_rgba(47,42,37,0.06),0_2px_8px_-4px_rgba(47,42,37,0.08)] ring-1 ring-inset ring-white/40 transition-[transform,box-shadow,border-color] duration-200 ease-out hover:-translate-y-1 hover:border-pine/70 hover:shadow-[0_2px_4px_rgba(47,42,37,0.04),0_14px_28px_-16px_rgba(47,42,37,0.18)] active:scale-[0.99] motion-reduce:active:scale-none focus-visible:border-pine/70 dark:focus-visible:border-mint/60 motion-reduce:transition-none motion-reduce:hover:translate-none dark:border-cream/15 dark:bg-choc-elevated dark:ring-white/5 dark:shadow-none dark:hover:shadow-[0_0_0_1px_rgba(201,178,124,.25),0_14px_30px_-14px_rgba(0,0,0,.7)] dark:hover:border-mint/60"
              >
                <div>
                  <div className="flex items-center justify-between gap-2">
                    <span className={`badge-leak-guard rounded-full bg-brass/20 px-2.5 py-0.5 text-[11px] font-semibold text-ink dark:bg-brass/15 dark:text-cream ${lang === "en" ? "uppercase tracking-[0.10em]" : "tracking-normal"}`}>
      ...
      <section className="band-wipe-s5 full-bleed bg-choc py-24 sm:py-32 lg:py-40 text-cream" data-band="choc">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              <FolioMarker lang={lang} label={t.folioCommunity} className="mb-4 text-brass-dark" />
              <h2
